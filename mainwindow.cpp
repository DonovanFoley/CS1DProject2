...
/*
 integrate this into mainiwindow.cpp
// mainwindow.cpp
...
MainWindow::MainWindow(QWidget *parent) :
    ...
    // Here you would load your stadium data from the database and add edges
    // g.addEdge("StadiumA", "StadiumB", distance);

    // Example of adding edges manually (you will pull this data from your DB)
    g.addEdge("Stadium1", "Stadium2", 3.2);
    g.addEdge("Stadium1", "Stadium3", 5.0);
    // ... more edges ...

    vector<Edge> mst = g.primMST();

    // mst has your minimum spanning tree.
    // iterate over 'mst' and update UI
}
